...
const User = [
  { id: "son7", nickname: "Sonny", image: "/yRsRRjGO.jpg" },
  { id: "kevin17", nickname: "De Bruyne", image: "/5Udwvqim.jpg" },
  { id: "rodrigo", nickname: "Rodri", image: faker.image.avatar() },
];
const Posts = [];
...
export const handlers = [
  ...
  http.get("/api/trends", ({ request }) => {
    return HttpResponse.json([
      { tagId: 1, title: "foden", count: 1264 },
      { tagId: 2, title: "ake", count: 1264 },
      { tagId: 3, title: "walker", count: 1264 },
      { tagId: 4, title: "gvardiol", count: 1264 },
      { tagId: 5, title: "doku", count: 1264 },
      { tagId: 6, title: "b.solva", count: 1264 },
      { tagId: 7, title: "haaland", count: 1264 },
      { tagId: 8, title: "alvarez", count: 1264 },
      { tagId: 9, title: "pep", count: 1264 },
    ]);
  }),
];
